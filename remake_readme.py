...
def format_data_for_openai(readme_content, main_content, remake_content, utility_content):
    prompt = None
        ...
        messages = [
            {
                ...
                "content": f'''
                    ...
                    Based on the provided information, update the README so that it accurately reflects the application, following the best practices for a README from the gathered context. 
                        Context: {context}
                ''',
            },
...
def main():
    ...
    prompt = format_data_for_openai(readme_content, main_content, remake_content, utility_content)
