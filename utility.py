...
def format_data_for_openai(diffs, readme_content, commit_messages):
    ...
    changes = "\n".join([f"File: {file['filename']}\Diff: {file['patch']}" for file in diffs])
    ...
    prompt = (
        "Please review the following code changes and commit message from a Github request: \n"
...
def update_readme_and_create_pr(repo, updated_readme, readme_sha):
    ...
    pr_title = "Update README based on recent changes using gpt3.5"
